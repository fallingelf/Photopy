...
#########################################主程序部分#############################################################################################################################
data_in='C:\\Users\\falli\\Desktop\\Project\\Photutils\\data85';os.chdir(data_in)
data_out='C:\\Users\\falli\\Desktop\\Project\\Photutils\\phres';
#----------------------------------------测光目标设置---------------------------------------------------------------------------------------
object_list=['20190403NS0782']                         #测光目标
ref_image_list=['20190403NS0782-0050N.fit']            #对应的参考图
pixel_coo_star1=[[1053.8,998.6],[708.2,926.6],[849.8,1215.8],[1225.4,870.2],[1599.8,1151.]] #对应的参考图上的目标位置,多个则分别命名为pixel_coo_star2,pixel_coo_star3....
ref_pixel_coo_list=[pixel_coo_star1]                 #多个目标改写为[pixel_coo_star1,pixel_coo_star2,pixel_coo_star3]
radec_star1='15 33 49.44 +37 59 28.2'
...
trim_size=np.array([[200,2000],[200,2000]]) #裁图尺寸
